...
function CustomSelect(props) {
  ...
  const handleClickOutside = e => !componentRef.current.contains(e.target) && opened && setOpened(false)
  ...
  return (
    <div ref={componentRef} className={cn()} onKeyDown={e => e.code === "Escape" && opened && setOpened(false)}
         onKeyDownCapture={e => {
